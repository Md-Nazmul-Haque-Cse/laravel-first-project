        ...
        <ul class="side-menu metismenu">
            ...
            <li>
                <a href="javascript:;"><i class="sidebar-item-icon fa fa-bar-chart"></i>
                    <span class="nav-label">Unique Module</span><i class="fa fa-angle-left arrow"></i></a>
                <ul class="nav-2-level collapse">
                    <li>
            ...
            <li>
                ...
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="mailbox.html">Mange Order</a>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                <a href="" onclick="event.preventDefault();document.getElementById('logoutForm').submit()"><i class="sidebar-item-icon fa fa-power-off"></i>Logout</a>
