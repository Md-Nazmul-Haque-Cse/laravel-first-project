...
@section('body')
    <main class="main">
        <div class="page-header text-center" style="background-image: url('{{asset('/')}}assets/images/page-header-bg.jpg')">
            <div class="container">
                <h1 class="page-title">All Category Products<span>Shop</span></h1>
            </div><!-- End .container -->
        </div><!-- End .page-header -->
        <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">All Category Product</li>
                </ol>
            </div><!-- End .container -->
                                    ...
                                    <div class="product product-7 text-center">
                                        ...
                                        <div class="product-body">
                                            ...
                                            <div class="product-nav product-nav-thumbs">
                                                ...
                                                <a href="{{route('product-detail',['id'=>base64_encode($product->id)])}}" class="active">
