...
//    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/manage-product')->with('updatemessage', 'Product Updated successfully');
    }

    public function delete(Request $request, $id )
    {
        Product::deleteProduct($id);
        return redirect('/manage-product')->with('deletemessage', 'Product deleted successfully');
    }
