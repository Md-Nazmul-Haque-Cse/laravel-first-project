...
class UnitController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/manage-unit')->with('updatemessage', 'Unit info Updated successfully');
    }

    public function delete(Request $request, $id )
    {
        Unit::deleteUnit($id);
        return redirect('/manage-unit')->with('deletemessage', 'Unit info deleted successfully');
    }
}
