...
class CategoryController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/manage-category')->with('updatemessage', 'Category Updated successfully');
    }

    public function delete(Request $request, $id )
    {
        Category::deleteCategory($id);
        return redirect('/manage-category')->with('deletemessage', 'Category deleted successfully');
    }
}
