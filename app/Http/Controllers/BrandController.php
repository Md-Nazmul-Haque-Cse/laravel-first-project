...
class BrandController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/manage-brand')->with('updatemessage', 'Brand info Updated successfully');
    }

    public function delete(Request $request, $id )
    {
        Brand::deleteBrand($id);
        return redirect('/manage-brand')->with('deletemessage', 'Brand info deleted successfully');
    }
